...
namespace dev_connect.Server.Services.MessageService
{
    ...
    public class EmailService : IEmailService
    {
        ...
        public EmailService(IConfiguration configuration)
        {
            ...
            _client = new()
            {
                ...
                Credentials = new System.Net.NetworkCredential(_SmtpMailAddress, _SmtpUserName),
                Host = _SmtpHost,
                EnableSsl = bool.Parse("true")
            };
        }
        public void SendEmail(string toAddress, string sublect, string mailBody)
        {
            try
            {
                ...
                var header = mailHeader.Replace("{Subject}", sublect);
                string message = header + mailBody + mailFooter;
